...
var listBtnEls = document.querySelectorAll('[class*=carousel-item]');
var contentsItem = document.querySelectorAll('[class=item-contents');
...
for (var i = 0; i < listBtnEls.length; i++) {
  _loop(i);
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5329" + '/');
